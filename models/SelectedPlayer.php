 ...
 */
class SelectedPlayer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Name, School, Year, Weight, est_round, est_pick, position', 'required'),
			...
			array('id, Name, School, Year, Weight, dash, reps, cone, shuttle, vjump, bjump, alength, hlength, est_round, est_pick, position, height, player_weight', 'safe', 'on'=>'search'),
		);
	}
   public function defaultScope()
	 ...
	 * @return SelectedPlayer the static model class
	 */
